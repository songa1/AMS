  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center bg-gray-50 p-5">
      ...
      <button
        ...
        className="px-6 py-3 text-lg font-medium text-white bg-primary rounded-lg shadow-xl hover:bg-primary/80 transition duration-300 focus:outline-none focus:ring-4 focus:ring-blue-300"
      >
        Go to Homepage
      </button>
    </div>
