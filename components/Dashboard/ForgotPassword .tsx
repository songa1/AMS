...
const ForgotPasswordPage = () => {
  ...
  const [isTouched, setIsTouched] = useState<{email:boolean}>({email: false});
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen p-4 sm:p-6 bg-gray-50">
      <div className="w-full max-w-md flex flex-col items-center bg-white border border-indigo-200 rounded-xl shadow-2xl p-6 sm:p-8">
        
        <Header />
        
        {/* Decorative Separator */}
        <div className="w-full h-2 bg-indigo-600 rounded-t-lg shadow-md mb-6"></div>
          ...
          <form className="w-full space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                onBlur={handleBlur}
                required
                className={`w-full p-3 border rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 transition duration-150
